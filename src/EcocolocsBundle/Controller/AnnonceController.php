...
use EcocolocsBundle\Entity\Annonce;
...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $annonces = $em->getRepository('EcocolocsBundle:Annonce')->findAll();

        return $this->render('@Ecocolocs/annonce/index.html.twig', array(
            'annonces' => $annonces,
        ));
    }
    ...
    {
        $annonce = new Annonce();
        $form = $this->createForm('EcocolocsBundle\Form\AnnonceType', $annonce);
        ...
        return $this->render('@Ecocolocs/annonce/new.html.twig', array(
            'annonce' => $annonce,
    ...
    public function showAction(Annonce $annonce)
    {
        ...
        return $this->render("@Ecocolocs/annonce/show.html.twig", array(
            'annonce' => $annonce,
    ...
    {
        $deleteForm = $this->createDeleteForm($annonce);
        $editForm = $this->createForm('EcocolocsBundle\Form\AnnonceType', $colocation);
        ...
        return $this->render('@Ecocolocs/annonce/edit.html.twig', array(
            'annonce' => $annonce,
